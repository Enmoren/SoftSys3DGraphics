...
import com.dragon.arnav.basicFuction.util.AMapUtil;
...
/**
 * This file created by dragon on 2016/7/19 16:53,belong to com.dragon.arnav.basicFuction.LocationMap .
 */
...
//    检测搜索关键字是否为空，不为空就开始搜索
    public void searchButton() {
        ...
        if ("".equals(keyWord)) {
            ToastUtil.show(LocationMap.this, "请输入搜索关键字");
            return;
        } else {
            doSearchQuery();
        }
...
//    }
    ...
    public void onTextChanged(CharSequence s, int start, int before, int count) {
        ...
        if (!AMapUtil.IsEmptyOrNullString(newText)) {
            ...
            Inputtips inputTips = new Inputtips(LocationMap.this, inputquery);
